...
/**
 * @Class Name : SeedUtil.java
 * SEED를 이용한 암호화 처리 유틸 클래스
 * @Modification Information
 *
 *    수정일       수정자         수정내용
 *    -------        -------     -------------------
 *    2011. 6. 15.     구본웅    최초생성
 *    2011. 6. 16.     구본웅    운영모드 ECB => CBD로 변경
 *    							byte[] 끼리 XOR연산 처리하는 exclusiveOR 메서드 추가
 *
 * @author 구본웅 (dev.catchbug@gmail.com)
 * @since 2011. 6. 15.
 * @version 0.2
 * 
 */
public class SeedUtil{
	 ...
	 * @throws Exception
	 */
	public static String getSeedDecrypt(String encVal) throws Exception{
...
//		System.out.println("복호화할 바이트 종료");
	 ...
	 * @throws Exception
	 */
	public static String getSeedEncrypt(String strVal) throws Exception{
		int[] seedKey = SeedUtil.getSeedRoundKey("1234567890123456");
...
//			KC0 = golden ratio; KCi = ROTL(KCi-1, 1) 	
	...
	// reorder for little endian	  
		...
		public static void main(String args[]) throws Exception{
             // 암복호화에 사용할 키 배열생성
            int[] seedKey = SeedUtil.getSeedRoundKey("1234567890123456");
            String nomalStr = "1234";
            String encStr = SeedUtil.getSeedEncrypt(nomalStr);
            System.out.println("encStr : " + encStr);
            String decStr = SeedUtil.getSeedDecrypt(encStr);
